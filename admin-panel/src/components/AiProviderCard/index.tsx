      ...
      <div className="mt-auto pt-3 flex items-center justify-between border-t border-gray-100 dark:border-zinc-700/50">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="cursor-pointer p-1.5 rounded-lg text-zinc-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 dark:hover:text-indigo-400 transition-colors"
            title={t('pages.settings.buttons.edit_provider', { defaultValue: 'Edit Provider' })}
          >
          ...
          <button
            ...
            className="cursor-pointer p-1.5 rounded-lg text-zinc-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 dark:hover:text-red-400 transition-colors"
            title={t('pages.settings.buttons.delete_provider', { defaultValue: 'Delete Provider' })}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
